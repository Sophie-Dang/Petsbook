...
function petsbook_carousel_login($wp_customize) 
{
    ...
    // Change Illu
    $wp_customize->add_setting (
        'petsbook_carousel_login_slide1_Illu',
        [
    ...
    $wp_customize->add_setting(
        'petsbook_carousel_login_slide1_title',
        [
    ...
    // Change text content
    $wp_customize->add_setting(
        'petsbook_carousel_login_slide1_content',
        [
    ...
    // Change Illu
    $wp_customize->add_setting (
        'petsbook_carousel_login_slide2_Illu',
        [
    ...
    // Change content title
    $wp_customize->add_setting(
        'petsbook_carousel_login_slide2_title',
        [
    ...
    // Change text content
    $wp_customize->add_setting(
        'petsbook_carousel_login_slide2_content',
        [
            'default' => 'Nulla vitae elit libero, a pharetra augue mollis interdum. Lorem, ipsum dolor sit amet consectetur adipisicing elit. Repudiandae, dolor laboriosam. Quibusdam saepe quidem quos nulla illum maxime magni dignissimos ut inventore. Architecto sit, esse distinctio autem facilis fugit cumque.?'
        ]
    );
    ...
    // Change Illu
    $wp_customize->add_setting (
        'petsbook_carousel_login_slide3_Illu',
        [
            'default' => get_theme_file_uri('public/images/Illu-1-2.png')
        ]
    );
    ...
    // Change content title
    $wp_customize->add_setting(
        'petsbook_carousel_login_slide3_title',
        [
    ...
    // Change text content
    $wp_customize->add_setting(
        'petsbook_carousel_login_slide3_content',
        [
            'default' => 'Nulla vitae elit libero, a pharetra augue mollis interdum. Lorem, ipsum dolor sit amet consectetur adipisicing elit. Repudiandae, dolor laboriosam. Quibusdam saepe quidem quos nulla illum maxime magni dignissimos ut inventore. Architecto sit, esse distinctio autem facilis fugit cumque.?'
        ]
    );
    ...
    // Interval  
    $wp_customize->add_setting (
        'petsbook_carousel_login_interval',
        [
            'default' => 15000
        ]
    );
